...
LABEL org.opencontainers.image.version="20260920.pcie-opp-test-initrd-guard-02"
...
RUN set -eux; \
    ...
    printf '%s\n' '20260920.pcie-opp-test-initrd-guard-02' > /usr/lib/armada/version; \
    ...
    for path in \
        ...
        usr/lib/systemd/system/dracut-pre-mount.service.d/pcie-opp-recover.conf \
